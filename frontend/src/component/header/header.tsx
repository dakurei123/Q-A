      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <Form className="d-flex">
            <Container style={{ width: 'fit-content', height: 'fit-content', position: 'relative', padding: 0 }}>
              <FormControl type="search" placeholder="Search" className="mr-2" aria-label="Search" style={{ paddingRight: 30 }} />
              <Button variant="outline-primary" style={{ position: 'absolute', top: '0', right: '0' }}>
          ...
          <Nav>
            <Nav.Link style={{ padding: 0 }}>
              <Principal isLogin={isLogin}></Principal>
            </Nav.Link>
          </Nav>
        </Navbar.Collapse>
      </Container>
